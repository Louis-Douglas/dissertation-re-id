...
def count_segmented_objects(image_dir, model_path="yolo11n-seg.mlpackage"):
    """
...
def process_directories(directories, model_path="yolo11n-seg.mlpackage", max_workers=4):
    """
...
directories = []
root_path = "../../datasets/Ethical-filtered"
...
final_results = process_directories(directories, model_path="../../weights/yolo11n-seg.mlpackage", max_workers=2)
